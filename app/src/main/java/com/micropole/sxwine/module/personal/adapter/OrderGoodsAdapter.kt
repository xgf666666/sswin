 ...
 */
class OrderGoodsAdapter(resLayoutId:Int, data:List<MyOrderItemEntity.ItemsBean>?) : BaseQuickAdapter<MyOrderItemEntity.ItemsBean,BaseViewHolder>(resLayoutId,data){

    override fun convert(helper: BaseViewHolder?, item: MyOrderItemEntity.ItemsBean?) {
