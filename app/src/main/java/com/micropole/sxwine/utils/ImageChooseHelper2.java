...
public class ImageChooseHelper2 {
    /**
     * 相机获取图片
     */
    ...
    private ImageChooseHelper2(Activity activity) {
        activityWeakReference = new WeakReference<>(activity);
    }

    private ImageChooseHelper2(Fragment fragment) {
    ...
    static public class Builder {
        ...
        public Builder setUpFragment(Fragment fragment) {
            imageChooseHelper = new ImageChooseHelper2(fragment);
            return this;
        }

        public Builder setUpActivity(Activity activity) {
            imageChooseHelper = new ImageChooseHelper2(activity);
            return this;
        }
        ...
        public ImageChooseHelper2 create() {
