    ...
    public CountDownProgressView(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null){
            ...
            if (typedArray.hasValue(R.styleable.CountDownProgress_circSolidColor)){
                ...
                //没有这个属性索引 默认是浅灰色
                circSolidColor = typedArray.getColor(R.styleable.CountDownProgress_circSolidColor, Color.parseColor("#50000000"));
            }
            ...
            if (typedArray.hasValue(R.styleable.CountDownProgress_circFrameColor)){
                ...
                //没有这个属性索引 默认是深灰色
                circFrameColor = typedArray.getColor(R.styleable.CountDownProgress_circFrameColor,Color.parseColor("#00000000"));
            }
